 ...
 *
 */
float PID_Position(digital_PID_t *hpid, float val_now, float target_now)
{
 ...
 *
 */
float PID_Incrment(digital_PID_t *hpid, float val_now, float target_now)
{
 ...
 *
 */
void PID_Clear(digital_PID_t *hpid)
{
    hpid->Err_pre = 0;
    hpid->Err_last = 0;
    hpid->Err_now = 0;
