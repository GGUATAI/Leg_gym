...
extern float PID_Position(digital_PID_t *hpid, float val_now, float target_now);

extern float PID_Incrment(digital_PID_t *hpid, float val_now, float target_now);

extern void PID_Clear(digital_PID_t *hpid);
