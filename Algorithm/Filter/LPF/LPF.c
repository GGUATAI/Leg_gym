...
//void MOVINGAVERAGEFILTER_Init(movingaverage_filter_t *MAF)
//{
//    MAF->Input = 0;
//    memset(MAF->Output, 0, sizeof(MAF->Output));
//    MAF->Initialized = false;
//}
//
//float MovingAverageFilter_Update(movingaverage_filter_t *MAF, float Input)
//{
//
//    MAF->Input = Input;
//
//    if (MAF->Initialized == false)
//    {
//        memset(MAF->Output, Input, sizeof(MAF->Output));
//        MAF->Initialized = true;
//    }
//
//    for (int i = 0; i < 9; i++)
//    {
//        MAF->Output[i] = MAF->Output[i + 1];
//    }
//    MAF->Output[9] = MAF->Input;
//
//    float sum = 0;
//    for (int i = 0; i < 10; i++)
//    {
